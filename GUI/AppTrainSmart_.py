...
#       
   ...
   # Creamos ventana para el primer botón
        ...
        ventana_del_primer_boton.geometry('300x500')  # Ajustamos tamaño

        # Hacemos que las columnas y filas se ajusten
        ...
        self.scrollable_checkbox_frame.grid(row=0, column=0, padx=3, pady=(5, 10), sticky="nsew")
        ...
        self.scrollable_checkbox_frame_2.grid(row=1, column=0, padx=3, pady=(5, 10), sticky="nsew")
